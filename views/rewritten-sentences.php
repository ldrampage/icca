                            ...
                            <div class="row"> 
                                ...
                                <div class="col-md-2 col-sm-12" style="margin-bottom:10px">
                                    ...
                                    <select class="form-control select2" id="categoryFilter">
                                        <option value="">All</option>
                                        <?php 
                                            $catLists = $iccaFunc->fetchCategoryList();
...
<script>
    $(document).ready(function() {
        ...
        $("#categoryFilter").on("change", function() {
            rewritesTable.column(0).search('').column(10).search(this.value).draw();
        ...
        $("#editorFilter").on("change", function() {
            rewritesTable.column(6).search(this.value).draw();
        });
